...
1. [数据获取(Data Collection)](https://github.com/ddddwy/StockForecast/tree/master/crawler):<br>
...
![](https://github.com/ddddwy/StockForecast/blob/master/img/WebCollector%20core%20framework.png)
...
3. [模型建立(Model Building)]():
	...
	* News Classification Model Based on News Headlines: Classify the important financial issues based on the news headlines. Build CNN-RNN multi-classification 
	...
	![](https://github.com/ddddwy/StockForecast/blob/master/img/CNN-RNN.png)
	...
	* Stock Trend Prediction Model: Take the text data and the company financial data from the t-14 trading day to the t-1 trading day as one unit sample data, 
	...
	![](https://github.com/ddddwy/StockForecast/blob/master/img/LSTM.png)
